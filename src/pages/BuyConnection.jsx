 ...
 return (
  ...
  >
   ...
   {/* <button
    ...
    className={`w-full py-4 rounded-lg text-xl font-bold transition-colors shadow-lg
     ${selectedPlan
    ...
    style={{
     background: selectedPlan
      ? `linear-gradient(90deg, ${PRIMARY_COLOR} 0%, #a78bfa 100%)`
      : '#d1d5db',
   ...
   >
    {selectedPlan ? `Buy ${selectedPlan.name} Plan` : 'Select a Plan'}
   </button> */}
